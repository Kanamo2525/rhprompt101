...
export default function ClientMatricePage() {
  ...
  // Structured data for the matrix page
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebApplication",
    name: "Matrice d'Opportunités IA pour les RH",
    description:
      "Outil analytique interactif pour cartographier les opportunités d'IA générative en ressources humaines",
